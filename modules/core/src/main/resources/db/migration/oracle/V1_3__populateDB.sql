...
INSERT INTO CUSTOMER_CONTACT (ID, FIRST_NAME, SURNAME, PHONE, MOBILE_PHONE, FAX, EMAIL_ADDRESS, CUSTOMER_ID, SALUTATION, TYPE, LAST_MODIFIED_DATE, VERSION) VALUES
  (HIBERNATE_SEQUENCE.nextval, 'SMSC', 'SMSC', '0674329568', '0504569753', 'fake_fax', 'smsc@bulk.io', 1, 'MR', 'CEO', current_timestamp, 0);

INSERT INTO USER_ACCOUNT (ID, USERNAME, PASSWORD, SALT, FIRST_NAME, SURNAME, EMAIL, ACTIVE, BLOCKED, LAST_MODIFIED_DATE, VERSION, CUSTOMER_ID) VALUES
  (HIBERNATE_SEQUENCE.nextval, 'user', '541338d92cd0dbf230d7e7666dd99adaea8da7a478f5456947c2445aecea0b1a', 'ad68dc115126d9d1', 'userName', 'userSurname', 'user@gmail.com', 1, 0, current_timestamp, 0, 1);
INSERT INTO USER_ACCOUNT (ID, USERNAME, PASSWORD, SALT, FIRST_NAME, SURNAME, EMAIL, ACTIVE, BLOCKED, LAST_MODIFIED_DATE, VERSION, CUSTOMER_ID) VALUES
  (HIBERNATE_SEQUENCE.nextval, 'admin', 'b03209e6c608cdf3753ab36449703abeab6aa7aab628e569b37a55381d4aa021', '94bd6b18b8f70298', 'adminName', 'adminSurname', 'admin@gmail.com', 1, 0, current_timestamp, 0, 1);
...
INSERT INTO DASHBOARD (ID, NAME, ICON, USER_ACCOUNT_ID, LAST_MODIFIED_DATE, VERSION) VALUES
  (HIBERNATE_SEQUENCE.nextval, 'default', 'user', 3, current_timestamp, 0);
