...
INSERT INTO CUSTOMER (ID, COMPANY_NAME, STREET, STREET2, POSTCODE, COUNTRY, CITY, VATID, LAST_MODIFIED_DATE, VERSION) VALUES
  ...
  INSERT INTO CUSTOMER_USER_ACCOUNT (ID, USERNAME, PASSWORD, SALT, FIRST_NAME, SURNAME, EMAIL, ACTIVE, BLOCKED, CREATED, LAST_MODIFIED_DATE, VERSION, CUSTOMER_ID) VALUES
    (customer_user_account_seq.nextval, 'user', '541338d92cd0dbf230d7e7666dd99adaea8da7a478f5456947c2445aecea0b1a', 'ad68dc115126d9d1', 'userName', 'userSurname', 'user@gmail.com', 1, 0, current_timestamp, current_timestamp, 0, id_customer);
  INSERT INTO CUSTOMER_USER_ACCOUNT (ID, USERNAME, PASSWORD, SALT, FIRST_NAME, SURNAME, EMAIL, ACTIVE, BLOCKED, CREATED, LAST_MODIFIED_DATE, VERSION, CUSTOMER_ID) VALUES
    (customer_user_account_seq.nextval, 'admin', 'b03209e6c608cdf3753ab36449703abeab6aa7aab628e569b37a55381d4aa021', '94bd6b18b8f70298', 'adminName', 'adminSurname', 'admin@gmail.com', 1, 0, current_timestamp, current_timestamp, 0, id_customer);

  INSERT INTO USER_ACCOUNT (ID, USERNAME, PASSWORD, SALT, FIRST_NAME, SURNAME, EMAIL, ACTIVE, BLOCKED, CREATED, LAST_MODIFIED_DATE, VERSION) VALUES
    (user_account_seq.nextval, 'user', '541338d92cd0dbf230d7e7666dd99adaea8da7a478f5456947c2445aecea0b1a', 'ad68dc115126d9d1', 'userName', 'userSurname', 'user@gmail.com', 1, 0, current_timestamp, current_timestamp, 0) RETURNING ID INTO id_user;
  INSERT INTO USER_ACCOUNT (ID, USERNAME, PASSWORD, SALT, FIRST_NAME, SURNAME, EMAIL, ACTIVE, BLOCKED, CREATED, LAST_MODIFIED_DATE, VERSION) VALUES
    (user_account_seq.nextval, 'admin', 'b03209e6c608cdf3753ab36449703abeab6aa7aab628e569b37a55381d4aa021', '94bd6b18b8f70298', 'adminName', 'adminSurname', 'admin@gmail.com', 1, 0, current_timestamp, current_timestamp, 0) RETURNING ID INTO id_admin;
