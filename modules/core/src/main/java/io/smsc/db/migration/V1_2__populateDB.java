...
public class V1_2__populateDB implements SpringJdbcMigration {
    ...
    public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
        ...
        CrudMetaFormData crudMetaFormData1 = new CrudMetaFormData(64L, "fromProperty", true, true, null, 1.0, "String", null, null, null, newCrudClassMetaData6);
        CrudMetaFormData crudMetaFormData2 = new CrudMetaFormData(65L, "toProperty", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData6);
        CrudMetaFormData crudMetaFormData3 = new CrudMetaFormData(66L, "combineOperator", true, true, null, 3.0, "AND,OR,NOT", null, null, null, newCrudClassMetaData6);
        CrudMetaFormData crudMetaFormData4 = new CrudMetaFormData(67L, "operator", true, true, null, 4.0, "EQUALS,MORE,LESS,MORE_OR_EQUALS,LESS_OR_EQUALS,MORE_OR_LESS,LIKE,BETWEEN,IS,INSTANCE_OF,MATCHES", null, null, null, newCrudClassMetaData6);
        CrudMetaFormData crudMetaFormData5 = new CrudMetaFormData(68L, "columnWidth", true, true, null, 1.0, "Double", null, null, null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData6 = new CrudMetaFormData(69L, "property", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData7 = new CrudMetaFormData(70L, "editable", true, true, null, 3.0, "Boolean", null, null, null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData8 = new CrudMetaFormData(71L, "visible", true, true, null, 4.0, "Boolean", null, null, null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData9 = new CrudMetaFormData(72L, "decorator", true, true, null, 5.0, "String", null, null, null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData10 = new CrudMetaFormData(73L, "order", true, true, null, 6.0, "Double", null, null, null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData11 = new CrudMetaFormData(74L, "crudClassMetaData", true, true, null, 7.0, "URI", "CrudClassMetaData", "crud-class-meta-data", null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData12 = new CrudMetaFormData(75L, "bindingProperties", true, true, null, 8.0, "URI", "MetaDataPropertyBindingParameter", "meta-data-property-binding-parameters", null, newCrudClassMetaData1);
        CrudMetaFormData crudMetaFormData13 = new CrudMetaFormData(76L, "fieldLayoutGridPosition", true, true, null, 1.0, "String", null, null, null,newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData14 = new CrudMetaFormData(77L, "property", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData15 = new CrudMetaFormData(78L, "editable", true, true, null, 3.0, "Boolean", null, null, null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData16 = new CrudMetaFormData(79L, "visible", true, true, null, 4.0, "Boolean", null, null, null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData17 = new CrudMetaFormData(80L, "decorator", true, true, null, 5.0, "String", null, null, null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData18 = new CrudMetaFormData(81L, "order", true, true, null, 6.0, "Double", null, null, null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData19 = new CrudMetaFormData(82L, "crudClassMetaData", true, true, null, 7.0, "URI", "CrudClassMetaData", "crud-class-meta-data", null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData20 = new CrudMetaFormData(83L, "bindingProperties", true, true, null, 8.0, "URI", "MetaDataPropertyBindingParameter", "meta-data-property-binding-parameters", null, newCrudClassMetaData2);
        CrudMetaFormData crudMetaFormData21 = new CrudMetaFormData(84L,"customerId", true, true, null, 1.0, "Double", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData22 = new CrudMetaFormData(85L,"companyName", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData23 = new CrudMetaFormData(86L,"street", true, true, null, 3.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData24 = new CrudMetaFormData(87L,"street2", true, true, null, 4.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData25 = new CrudMetaFormData(88L,"postcode", true, true, null,5.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData26 = new CrudMetaFormData(89L,"country", true, true, null, 6.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData27 = new CrudMetaFormData(90L,"city", true, true, null, 7.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData28 = new CrudMetaFormData(91L,"vatid", true, true, null, 8.0, "Double", null, null, null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData29 = new CrudMetaFormData(92L,"contacts", true, true, null, 9.0, "URI", "CustomerContact", "customer-contacts", null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData30 = new CrudMetaFormData(93L,"users", true, true, null, 10.0, "URI", "User", "users", null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData31 = new CrudMetaFormData(94L,"parentCustomer", true, true, null, 11.0, "URI", "Customer", "customers", null, newCrudClassMetaData4);
        CrudMetaFormData crudMetaFormData32 = new CrudMetaFormData(95L,"name", true, true, null, 1.0, "String", null, null, null, newCrudClassMetaData7);
        CrudMetaFormData crudMetaFormData33 = new CrudMetaFormData(96L,"name", true, true, null, 1.0, "String", null, null, null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData34 = new CrudMetaFormData(97L,"description", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData35 = new CrudMetaFormData(98L,"type", true, true, null, 3.0, "URI", "DashboardBoxType", "dashboard-box-types", null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData36 = new CrudMetaFormData(99L,"dashboard", true, true, null, 4.0, "URI", "Dashboard", "dashboards", null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData37 = new CrudMetaFormData(100L,"width", true, true, null,5.0, "WIDTH_25,WIDTH_50,WIDTH_75,WIDTH_100", null, null, null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData38 = new CrudMetaFormData(101L,"height", true, true, null, 6.0, "HEIGHT_25,HEIGHT_50,HEIGHT_75,HEIGHT_100", null, null, null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData39 = new CrudMetaFormData(102L,"order", true, true, null, 7.0, "Integer", null, null, null, newCrudClassMetaData8);
        CrudMetaFormData crudMetaFormData40 = new CrudMetaFormData(103L,"name", true, true, null, 1.0, "String", null, null, null, newCrudClassMetaData9);
        CrudMetaFormData crudMetaFormData41 = new CrudMetaFormData(104L,"type", true, true, null, 2.0, "STATUS,CHART", null, null, null, newCrudClassMetaData9);
        CrudMetaFormData crudMetaFormData42 = new CrudMetaFormData(105L,"kind", true, true, null, 3.0, "PIE_CHART,SERIAL_CHART,LINE_CHART,BAR_CHART,BUBBLE_CHART,FEEDBACK_STATUS, PROFIT_STATUS,ORDERS_STATUS,USERS_STATUS", null, null, null, newCrudClassMetaData9);
        ...
        CrudMetaGridData crudMetaGridData1 = new CrudMetaGridData(106L, "fromProperty", true, true, null, 1.0, "String", null, null, null, newCrudClassMetaData6);
        CrudMetaGridData crudMetaGridData2 = new CrudMetaGridData(107L, "toProperty", true, true, null, 2.0,"String", null, null, null, newCrudClassMetaData6);
        CrudMetaGridData crudMetaGridData3 = new CrudMetaGridData(108L, "combineOperator", true, true, null, 3.0, "AND,OR,NOT", null, null, null, newCrudClassMetaData6);
        CrudMetaGridData crudMetaGridData4 = new CrudMetaGridData(109L, "operator", true, true, null, 4.0,"EQUALS,MORE,LESS,MORE_OR_EQUALS,LESS_OR_EQUALS,MORE_OR_LESS,LIKE,BETWEEN,IS,INSTANCE_OF,MATCHES", null, null, null, newCrudClassMetaData6);
        CrudMetaGridData crudMetaGridData5 = new CrudMetaGridData(110L, "columnWidth", true, true, null, 1.0, "Double", null, null, null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData6 = new CrudMetaGridData(111L, "property", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData7 = new CrudMetaGridData(112L, "editable", true, true, null, 3.0, "Boolean", null, null, null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData8 = new CrudMetaGridData(113L, "visible", true, true, null, 4.0, "Boolean", null, null, null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData9 = new CrudMetaGridData(114L, "decorator", true, true, null, 5.0, "String", null, null, null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData10 = new CrudMetaGridData(115L, "order", true, true, null, 6.0, "Double", null, null, null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData11 = new CrudMetaGridData(116L, "crudClassMetaData", true, true, null, 7.0, "URI", "CrudClassMetaData", "crud-class-meta-data", null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData12 = new CrudMetaGridData(117L, "bindingProperties", true, true, null, 8.0, "URI", "MetaDataPropertyBindingParameter", "meta-data-property-binding-parameters", null, newCrudClassMetaData1);
        CrudMetaGridData crudMetaGridData13 = new CrudMetaGridData(118L, "fieldLayoutGridPosition", true, true, null, 1.0, "String", null, null, null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData14 = new CrudMetaGridData(119L, "property", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData15 = new CrudMetaGridData(120L, "editable", true, true, null, 3.0, "Boolean", null, null, null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData16 = new CrudMetaGridData(121L, "visible", true, true, null, 4.0, "Boolean", null, null, null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData17 = new CrudMetaGridData(122L, "decorator", true, true, null, 5.0, "String", null, null, null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData18 = new CrudMetaGridData(123L, "order", true, true, null, 6.0, "Double", null, null, null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData19 = new CrudMetaGridData(124L, "crudClassMetaData", true, true, null, 7.0, "URI", "CrudClassMetaData", "crud-class-meta-data", null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData20 = new CrudMetaGridData(125L, "bindingProperties", true, true, null, 8.0, "URI", "MetaDataPropertyBindingParameter", "meta-data-property-binding-parameters", null, newCrudClassMetaData2);
        CrudMetaGridData crudMetaGridData21 = new CrudMetaGridData(126L,"customerId", true, true, null, 1.0, "Double", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData22 = new CrudMetaGridData(127L,"companyName", true, true, null, 2.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData23 = new CrudMetaGridData(128L,"street", true, true, null, 3.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData24 = new CrudMetaGridData(129L,"street2", true, true, null, 4.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData25 = new CrudMetaGridData(130L,"postcode", true, true, null,5.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData26 = new CrudMetaGridData(131L,"country", true, true, null, 6.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData27 = new CrudMetaGridData(132L,"city", true, true, null, 7.0, "String", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData28 = new CrudMetaGridData(133L,"vatid", true, true, null, 8.0, "Double", null, null, null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData29 = new CrudMetaGridData(134L,"contacts", true, true, null, 9.0, "URI", "CustomerContact", "customer-contacts", null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData30 = new CrudMetaGridData(135L,"users", true, true, null, 10.0, "URI", "User", "users", null, newCrudClassMetaData4);
        CrudMetaGridData crudMetaGridData31 = new CrudMetaGridData(136L,"parentCustomer", true, true, null, 11.0, "URI", "Customer", "customers", null, newCrudClassMetaData4);
