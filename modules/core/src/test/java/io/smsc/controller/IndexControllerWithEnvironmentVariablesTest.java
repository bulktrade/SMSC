...
@ContextConfiguration(initializers = IndexControllerWithEnvironmentVariablesTest.MockPropertyInitializer.class)
public class IndexControllerWithEnvironmentVariablesTest extends AbstractTest {
