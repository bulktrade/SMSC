...
public class PermissionTestData {
    ...
    static
    {
        PERMISSION_USER_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_USER_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_USER_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_USER_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_USER_READ_OWN.setRoles(Arrays.asList(ROLE_ADMIN, ROLE_USER));
        PERMISSION_USER_UPDATE_OWN.setRoles(Arrays.asList(ROLE_ADMIN, ROLE_USER));
        PERMISSION_ROLE_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_ROLE_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_ROLE_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_ROLE_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_PERMISSION_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_PERMISSION_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_PERMISSION_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_PERMISSION_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_CLASS_META_DATA_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_CLASS_META_DATA_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_CLASS_META_DATA_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_CLASS_META_DATA_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_FORM_DATA_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_FORM_DATA_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_FORM_DATA_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_FORM_DATA_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_GRID_DATA_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_GRID_DATA_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_GRID_DATA_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CRUD_META_GRID_DATA_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_META_DATA_PROPERTY_BINDING_PARAMETER_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_META_DATA_PROPERTY_BINDING_PARAMETER_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_META_DATA_PROPERTY_BINDING_PARAMETER_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_META_DATA_PROPERTY_BINDING_PARAMETER_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_CONTACT_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_CONTACT_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_CONTACT_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_CUSTOMER_CONTACT_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_TYPE_READ.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_TYPE_UPDATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_TYPE_CREATE.setRoles(Collections.singletonList(ROLE_ADMIN));
        PERMISSION_DASHBOARD_BOX_TYPE_DELETE.setRoles(Collections.singletonList(ROLE_ADMIN));
    }
